...
class VideoProcessingThread(QThread):
    ...
    def run(self):
        ...
        try:
            ...
            # Paso 3: Segmentar audio
            print("Paso 3: Segmentando audio...")
            audio_chunks = segment_audio(cleaned_audio_file, chunk_length_ms=120000)  # Segmentos de 2 minutos
            ...
            output_audio = generate_audio_from_text(" ".join(translated_segments), cleaned_audio_file, self.target_language)
            if not output_audio:
...
def segment_audio(audio_path, chunk_length_ms=120000):  # 2 minutos
